    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers("/prestador/ubicacion/nuevo").permitAll()
                        .pathMatchers("/prestador/nuevo").permitAll()
                        .pathMatchers("/solicitante/nuevo").permitAll()
                        ...
                        .pathMatchers("/servicio/*/elimincacion").hasRole("solicitante")
